...
//create object of invoice item
		...
		Scanner sr = new Scanner(System.in);
		 ...
		 {
		 System.out.println("Enter username( sa )");
		 String username = sr.next();
		 System.out.println("Enter password( root )");
		 ...
		 {
		 System.out.println(" worng user and pass ");
		...
		System.out.println("-_-_--_-_--_-_--_-_--_-_-  Invoicing System  -_-_--_-_--_-_--_-_--_-_-");
		while (i) {
			...
			if (switch1 == 1) {
				...
				while (manu2) {
					...
					switch (choose1) {
					case 1:
						System.out.println("-_-_-FIRST Enter the customer details-_-_-");
						init.ADDcustomer();
						init.addInvoice();
						break;
					case 2:
